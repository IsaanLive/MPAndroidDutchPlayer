...
import com.euroasia.nl.DownloadingActivity;
import com.euroasia.nl.R;
...
public class DownloadService extends Service {
	...
	public class DownloadFilesTask  extends AsyncTask<String, Void, Void> {
		...
		protected void onCancelled() {
			...
			regularNotif("Download Geannuleerd","Geannuleerd: "+filename,filename); 
		...
		protected void onPostExecute(Void result) {
			...
			if(fail == 1){
				regularNotif("Download Mislukt","Mislukt: "+filename,filename); 
				http--;
				...
				regularNotif("Download Voltooid","Voltooid: "+filename,filename); 
			}
		...
		public void ongoingNotif(String contentTitle, String tickerText, String contentText ){
			...
			notification.setLatestEventInfo(context, contentTitle, "Klik Hier om de Voortgang te bekijken", contentIntent);
			notificationManager.notify(numberd+9, notification);
		}
