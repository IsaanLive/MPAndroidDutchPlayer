...
public class ViewSongActivity extends Activity implements OnTouchListener, OnCompletionListener, OnBufferingUpdateListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
	    ...
	    if (mediafile.exists()) {
	    	...
	    	download.setText("Reeds gedownloadede Nummers");
		}
	...
	class ProgressTask extends AsyncTask<Integer, Integer, Void>{
		  ...
		  protected void onProgressUpdate(Integer integers) {
			  if(integers == 1) {
			    Toast.makeText(ViewSongActivity.this, "Nummer wordt gebufferd", Toast.LENGTH_SHORT).show(); 
			  }
		  }
